...
def run(dataset_dir, output_dir, name='voc_train', txt_name='train', shuffling=False):
    ...
    filenames = []
    txt_path = '/home/cecilia/leo_projects/SSD-Tensorflow-master/SVHN/ImageSets/Main/'+txt_name+'.txt'
    with open(txt_path) as file_txt:
