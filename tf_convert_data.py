...
tf.app.flags.DEFINE_string(
    'txt_name', 'train',
    'Filename in the MAIN of the IMAGESETS in the formate of VOC.')
tf.app.flags.DEFINE_string(
    'output_dir', './',
...
def main(_):
    ...
    if FLAGS.dataset_name == 'pascalvoc':
        pascalvoc_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name, FLAGS.txt_name)
    else:
